...
```
this takes a sequence of digits as inputs and generates a video as output where the machine generated hand written representation of the digits twine from one to the other sequentially.
